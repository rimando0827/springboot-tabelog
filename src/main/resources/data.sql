...
INSERT IGNORE INTO shops (id, category_id,name, image_name, description, price_lower_limit, price_upper_limit,opening_times, closed_times,postal_code, address, phone_number,closed_day) VALUES (6, 6,'NAGOYAピザ', 'shop01.jpg', 'かまどが設置されており、本格的なピザを楽しめます', '1000' , '3000' ,'19:00','23:00', '481-0046', '愛知県北名古屋市石橋X-XX-XX', '012-345-100','月、水');
